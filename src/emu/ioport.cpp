...
time_t ioport_manager::initialize()
{
	...
	machine().configuration().config_register(
			"aliases", 
			configuration_manager::load_delegate(&ioport_manager::load_alias, this),
			configuration_manager::save_delegate(&ioport_manager::save_alias, this));
...
//-----------------------------------------------------------------
void ioport_manager::load_alias(config_type cfg_type, config_level cfg_level, util::xml::data_node const *parentnode)
{
